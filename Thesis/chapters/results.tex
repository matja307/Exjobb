...
\begin{tabular}{l c c c c c r}
  ...
  \vspace{1mm}
   & \small{Temp. [$^\circ$C]} & \small{Time [h:min]} & \small{Thickness [$\mu$m]} &R [$\mu$m/h] & \small{Doping [cm$^{-3}$]} & Mode\\
    \hline
  D1 &  &  &  & & 10$^{18}$&Direct \\ %S1
  D2 & 1825 & 2:30 & 350 & 140 & 10$^{18}$&Direct \\ %S3
  D3 & 1825 & 3:00 & 360 & 120 &10$^{18}$&Direct \\	%S2
  D4 &  &  & 440 & & 10$^{19}$&Direct \\ %S1
  D5 & 1825 & 2:30 & 320 & 128 &10$^{19}$&Direct \\ %S2
  D6 &  &  &  & & 10$^{20}$&Direct \\%S1
  D7 & 1825 & 2:30 & 220 & 88 &10$^{20}$&Direct \\%S2
  D8 & 1825 & 2:30 & 380 & 152 & 10$^{18}$&Indirect \\%S3
%  2 & XXX & X:XX & X & 10$^{20}$&Indirect\\%S2 %BG proper
  D9 & 1825 & 2:30 & 380 & 152 &10$^{20}$&Indirect \\%S3
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.07]{direct_indirect_e18_2.jpg}
